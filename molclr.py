...
def main():
    ...
    elif config['aug'] == 'tox_substr_remove':
        from dataset.dataset_tox_remove import MoleculeDatasetWrapper
    elif config['aug'] == 'tox_substr_leave':
        from dataset.dataset_tox_leave import MoleculeDatasetWrapper
    else:
